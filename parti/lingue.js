...
const IT = {
  ...
  etichette: {
    ...
    scia_chiara: 'Scie sottili e chiare',
  ...
  aiuti: {
    ...
    scia_chiara: "Vale quando andata e ritorno NON si distinguono: tutte le scie si disegnano sottili e chiare come l'andata. Il senso di marcia lo dicono le frecce.",
...
const EN = {
  ...
  aiuti: {
    ...
    scia_chiara: 'Applies when outbound and return are NOT told apart: every trail is drawn thin and light like the outbound leg. The arrows show the direction.',
