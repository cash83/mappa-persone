...
import { MAPPA_VERSIONE } from './costanti.js?v=3.0.3';
import { MappaPersone } from './scheda.js?v=3.0.3';
import { MappaPersoneEditor } from './editor.js?v=3.0.3';
import { parla } from './lingue.js?v=3.0.3';
