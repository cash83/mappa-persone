...
import { MAPPA_VERSIONE } from './costanti.js?v=3.0.6';
import { MappaPersone } from './scheda.js?v=3.0.6';
import { MappaPersoneEditor } from './editor.js?v=3.0.6';
import { parla } from './lingue.js?v=3.0.6';
