import { MAPPA_BASE, MAPPA_SFONDI, MAPPA_SFONDO, MAPPA_ZOOM } from './costanti.js';
...
export async function caricaLeaflet() {
  ...
  if (!window.__mappaSempliceLeaflet) {
    window.__mappaSempliceLeaflet = new Promise((ok, no) => {
  ...
  return window.__mappaSempliceLeaflet;
}
