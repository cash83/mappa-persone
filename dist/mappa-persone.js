...
import { MAPPA_VERSIONE } from './costanti.js?v=3.0.0';
import { MappaPersone } from './scheda.js?v=3.0.0';
import { MappaPersoneEditor } from './editor.js?v=3.0.0';
import { parla } from './lingue.js?v=3.0.0';
