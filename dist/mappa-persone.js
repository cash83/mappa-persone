...
import { MAPPA_VERSIONE } from './costanti.js?v=3.1.2';
import { MappaPersone } from './scheda.js?v=3.1.2';
import { MappaPersoneEditor } from './editor.js?v=3.1.2';
import { parla } from './lingue.js?v=3.1.2';
