...
import { MAPPA_VERSIONE } from './costanti.js?v=3.1.1';
import { MappaPersone } from './scheda.js?v=3.1.1';
import { MappaPersoneEditor } from './editor.js?v=3.1.1';
import { parla } from './lingue.js?v=3.1.1';
